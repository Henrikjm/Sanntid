...
float add_using_a_function(float x, float y);
...
int main() {
    ...
    printf("When you add 10 and 20 you get %f\n", add_using_a_function(10.0, 20.0));
    printf("\n");
    ...
    printf("MORALE: gcc will let you get away with anything as long as you don't compile with -Wall.\n");
